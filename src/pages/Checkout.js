          ...
          <div className="row">
            <div className="col-md-7">
              <div className="checkout-left-data">
                ...
                <p className="user-details">Imtious Islam (iarafat386@gmail.com)</p>
                ...
                <form action="" className="d-flex flex-wrap gap-15 justify-content-between">
                  ...
                  <div className="w-100">
                    <input type="text" placeholder="Apartment, Suit, etc." className="form-control"></input>
                  </div>
                  <div className="flex-grow-1">
                  ...
                  <div className="w-100">
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <Link to="/store" className="button2">Continue Shopping</Link>
                    </div>
                  </div>
                </form>
              </div>
                ...
                <div className="d-flex gap-10 align-items-center justify-content-between">
                  <div className="w-75 d-flex align-items-center gap-4">
                    <div className="w-25 position-relative">
                      <span style={{top : "-5px", right: "-5px"}} className="badge bg-secondary rounded-circle position-absolute">1</span>
